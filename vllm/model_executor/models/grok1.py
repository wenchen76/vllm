...
class Grok1DecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.attn = Grok1Attention(
            ...
            max_position=(config.context_len if hasattr(config, "context_len")
        ...
        #num_experts = config.num_local_experts if hasattr(config, "num_local_experts") else getattr(config, "num_experts")
